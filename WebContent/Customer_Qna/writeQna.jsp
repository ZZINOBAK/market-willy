	...
	<div id="main" >
            <div id="content" >
                <div class="main_page_aticle">
                    <div class="form">
                        <h3 class="main_title">문의사항 작성</h3>
						<p class="sub">
                            <span id="ico">*</span>
                            필수입력사항
                        </p>
                        
                        <form action="qnaWriter" method="POST" onsubmit="return validateForm();">
                        <input type="text" name="id" value="${vo.id }" hidden="hidden">
                            ...
                            <div class="row mb-3" id="font_size">
                              ...
                              <div class="col-sm-6 id_bell_f" id="sst" style="padding-top: 19px;">
                                <input type="text" name="qnaTitle" class="form-control" id="qnaTitle" placeholder="제목">
                              </div>
                            </div>
							<p class="sub"></p>
                            ...
                            <div class="row mb-3" id="font_size">
                              ...
                              <div class="col-sm-6 pw_bell_f" id="sst">
                                <textarea name="qnaContent" class="form-control"  id="qnaContent"></textarea>
                              </div>
                            </div>
							<p class="sub"></p>
							
							<div class="row mb-3" id="font_size">
                              <label for="loginId" class="col-sm-2 col-form-label" id="fst" style="padding-top:29px; ">게시글 비밀번호</label>
                              <div class="col-sm-6 id_bell_f" id="sst" style="padding-top: 19px;">
                                <input type="text" name="qnaPwd" class="form-control" id="qnaPwd" placeholder="게시글 비밀번호">
                              </div>
                            </div>
                            
                              <div class="boder_btom"></div>
                              <div id="formSubmit" class="form_footer">
                                <button type="submit" class="btn active btn_join">작성하기</button>
